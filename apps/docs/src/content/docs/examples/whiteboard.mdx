---
title: 'Whiteboard'
description: A live demo of @insession/plugin-whiteboard-state — a shared free-draw canvas plus a "drawing telephone" relay game, with every call it made shown next to them.
---
...
See the [package reference](/packages/plugin-whiteboard-state/) for the full
