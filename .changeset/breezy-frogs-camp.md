...
Add `@insession/plugin-watch-party-state`, a dependency-free, server-authoritative Watch Party state machine: synchronized video/audio playback (YouTube or SoundCloud) with a queue and history.
